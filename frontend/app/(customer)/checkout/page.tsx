    ...
    return (
      <div className="max-w-2xl mx-auto p-4 md:p-8 text-center">
        <div className="glass-card p-8">
          ...
          <div className="bg-white/[0.05] border border-white/10 p-4 rounded-lg mb-8 inline-block text-left">
            <p className="text-sm text-white/40 mb-1">Booking Reference ID</p>
            <p className="font-mono font-bold text-lg text-white">{bookingData.qrReference}</p>
          </div>
          <div>
  ...
  return (
    <div className="max-w-2xl mx-auto p-4 md:p-8">
      <div className="glass-card p-8">
        ...
        {error && (
          <div className="bg-red-500/10 text-red-400 border border-red-500/20 p-4 rounded-lg mb-6">
            {error}
          </div>
        )}
